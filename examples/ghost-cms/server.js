...
const CX = {
  stack: 'Ghost',
  accent: '#9f1d51',
  title: 'Ghost + Corsen Context',
  h1: 'A Ghost publication that talks to AI agents',
  lede: 'This publication runs on Ghost. Corsen Context reads its Content API and hands agents four explicit, read-only tools - over MCP, over WebMCP inside this page, and through llms.txt - so an assistant can find and read the real posts instead of scraping them.',
  noun: 'posts',
  nounSing: 'post',
  postsH2: 'Latest posts',
  postsIntro:
    'Every card below is a live Ghost post. The same records answer search_site, list_content and get_page_content.',
  source: 'The Ghost Content API',
  rule: 'published posts only, read with a read-only content key that never leaves the server',
  envHint: ', GHOST_API_URL and a read-only GHOST_CONTENT_KEY',
  repo: 'https://github.com/CorsenAI/corsen-context-ghost',
  description:
    'A Ghost publication made agent-native with Corsen Context: four read-only tools over MCP, WebMCP and llms.txt.',
};
...
${bridgeTag}</head>
<body>
<div data-cc-nav data-stack="Ghost" data-uid="ghost" data-home="#top" data-accent="#9f1d51"></div>
...
<section id="live" class="cx-section cx-live">
  ...
  <div data-cc-observatory data-stack="Ghost" data-endpoint="/v1/mcp" data-query="Ghost" data-accent="#9f1d51"></div>
</section>
</main>
<footer data-cc-foot data-stack="Ghost" data-accent="#9f1d51"></footer>
<script>/* ============================================================
