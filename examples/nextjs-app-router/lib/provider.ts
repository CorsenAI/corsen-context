...
export const demoProvider: ContentProvider = {
  async getPages() {
    return [
      ...
      {
        url: 'https://demo.example.com/blog/getting-started',
      ...
      {
        url: 'https://demo.example.com/blog/mcp-explained',
        title: 'MCP Explained',
  ...
  async getPageContent(url) {
    const pages: Record<string, { title: string; markdown: string }> = {
      ...
      'https://demo.example.com/blog/getting-started': {
        title: 'Getting Started with AI Context',
        markdown:
      ...
      'https://demo.example.com/blog/mcp-explained': {
        title: 'MCP Explained',
        markdown:
