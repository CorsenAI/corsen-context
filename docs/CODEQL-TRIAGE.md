# CodeQL alert triage (main, 2026-09-02)

The current GitHub view contains 46 historical alerts: 13 fixed and 33
dismissed, with zero open alerts. Resolved by code, not dismissed: 3× `js/xss-through-dom`
