...
<img src="https://raw.githubusercontent.com/CorsenAI/corsen-context/main/.github/banner.png" alt="Corsen Context" width="100%" />
...
[![npm](https://img.shields.io/npm/v/@corsenai/corsen-context?color=cb3837&label=npm)](https://www.npmjs.com/package/@corsenai/corsen-context)
[![WordPress](https://img.shields.io/wordpress/plugin/v/corsen-context?color=21759b&label=WordPress)](https://wordpress.org/plugins/corsen-context/)
...
**Phase 1** — Core + WordPress + Next.js + CLI

**Phase 2 (current)** — Production hardening: DNS-aware SSRF protection, Redis cache/rate-limit, enhanced API keys, Pino logging, API versioning (`/v1/mcp`), npm + WordPress.org publishing

**Phase 3** — Astro/SvelteKit/Nuxt adapters, Express middleware, Anthropic Connectors Directory, MCP Registry listing

**Phase 4** — Launch campaign (Hacker News, Reddit, Dev.to), community adapters, "AI-Ready" badge program

**Phase 5** — Corsen Context Pro (analytics, AI query insights, custom instructions per page)
