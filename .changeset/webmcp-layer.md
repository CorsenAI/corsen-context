---
'@corsenai/corsen-context': minor
'@corsenai/corsen-context-nextjs': minor
'@corsenai/corsen-context-astro': minor
'@corsenai/corsen-context-cli': minor
---

Add the WebMCP surface: the same four tools, registered with an agent running inside the page through `document.modelContext`.
